...
const TimelineInitiale: React.FC = () => {
  const events: TimelineEvent[] = [
    {
      id: '1',
      title: 'Déclaration de sinistre',
      description: 'Informations collectées et déclaration en cours',
      date: '15/01/2024',
      time: '09:30',
      status: 'current',
      type: 'info'
    },
    {
      ...
      description: 'Dossier n° SIN-2024-001234 à ouvrir',
      date: 'À planifier',
      time: '',
      status: 'pending',
      type: 'warning'
    },
    {
      ...
      description: 'En attente de validation par le gestionnaire',
      date: 'À planifier',
      time: '',
      status: 'pending',
      type: 'warning'
              ...
              {event.status === 'current' && (
                <div className="mt-2">
                  <div className="w-full bg-gray-200 rounded-full h-1.5">
                    <div className="bg-axa-blue h-1.5 rounded-full w-1/4 animate-pulse"></div>
                  </div>
...
export default TimelineInitiale;
